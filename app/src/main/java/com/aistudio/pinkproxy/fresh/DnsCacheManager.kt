...
object DnsCacheManager {
    ...
    private val emergencyFallback = mapOf(
        ...
        "googlevideo.com" to listOf("172.217.16.14", "172.217.16.110", "142.250.185.78", "142.250.184.206", "172.217.20.78", "142.251.1.136"),
        "google.com" to listOf("8.8.8.8", "8.8.4.4", "142.250.180.14", "172.217.16.206"),
        "telegram.org" to listOf("149.154.167.99", "149.154.167.51", "149.154.165.120", "149.154.160.1", "91.108.56.100"),
