...
object StrategyExecutionRegistry {
    ...
    private val strategyExecutorMap: Map<BypassStrategy, Pair<ExecutorType, Set<TransportType>>> = mapOf(
        ...
        BypassStrategy.SOCKET_BUFFER_MANGLE to (ExecutorType.TCP_BASIC_HANDLER to setOf(TransportType.TCP)),
        ...
        BypassStrategy.SOCKET_BUFFER_SKEW to (ExecutorType.TCP_BASIC_HANDLER to setOf(TransportType.TCP)),
        ...
        BypassStrategy.SOCKET_BUFFER_CHAOS to (ExecutorType.TCP_BASIC_HANDLER to setOf(TransportType.TCP)),
        ...
        BypassStrategy.SOCKET_BUFFER_JITTER to (ExecutorType.TCP_BASIC_HANDLER to setOf(TransportType.TCP)),
        BypassStrategy.TCP_TLS_SESSION_DESYNC to (ExecutorType.TCP_BASIC_HANDLER to setOf(TransportType.TCP)),
        BypassStrategy.SOCKET_BUFFER_OSCILLATION to (ExecutorType.TCP_BASIC_HANDLER to setOf(TransportType.TCP)),
