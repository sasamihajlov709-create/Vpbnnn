...
# Replace Phase 4 VERY CAREFULLY
new_phase4 = '''
...
start_marker = r'            // Phase 4: Dynamic Risk and Cost based on observedFailureRate, observedLatency, and Sample Confidence'
end_marker = r'        return sorted\.map \{ it\.first \}\s*\}'

text = re.sub(start_marker + r'.*?' + end_marker, new_phase4.strip(), text, flags=re.DOTALL)

# Also fix the duplicated isStableMode
